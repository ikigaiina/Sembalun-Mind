...
export const AuthModal: React.FC<AuthModalProps> = ({ 
  ...
  const handleGoogleSignIn = async () => {
    setError('');
    setLoading(true);
    setLoadingState({ type: 'google', action: 'signin' });
    try {
  ...
  const handleAppleSignIn = async () => {
    setError('');
    setLoading(true);
    setLoadingState({ type: 'apple', action: 'signin' });
    try {
          ...
          <>
            ...
            <div className="mt-6 space-y-4">
              ...
              >
                ...
                {loadingState.type === 'google' ? 'Connecting...' : 'Continue with Google'}
              </Button>
              ...
              >
                ...
                {loadingState.type === 'apple' ? 'Connecting...' : 'Continue with Apple'}
              </Button>
              ...
              >
                ...
                {loadingState.type === 'guest' ? 'Setting up...' : 'Continue as Guest'}
              </Button>
            </div>
          </>
        )}
