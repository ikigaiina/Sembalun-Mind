...
import { Card, MeditationCard, CulturalCard } from '../components/ui/Card';
import { Button, MeditationButton } from '../components/ui/Button';
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 space-y-6 max-w-md mx-auto">
        ...
        {/* Daily mood check-in */}
        <MeditationCard variant="meditation" padding="md" hoverable>
          <MoodSelector 
        ...
        <CulturalCard variant="cultural" padding="md" hoverable gradient>
          <div className="flex items-center justify-between mb-4">
            <div className="text-left">
              <h3 className="font-heading text-lg text-cultural-brown">Perjalanan Mindful</h3>
              <p className="text-neutral-600 text-sm font-body">Konsistensimu membangun kedamaian</p>
            </div>
            <div className="flex flex-col items-center">
              <CairnIcon 
                progress={Math.min((userStats.currentStreak / 30) * 100, 100)} 
                size={40} 
                className="text-cultural-gold mb-1" 
              />
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t" style={{ borderColor: 'var(--color-cultural-earth-brown)20' }}>
            <div className="text-center">
              <div className="text-xl font-heading text-cultural-brown mb-1">
                {userStats.currentStreak}
              </div>
              <div className="text-xs text-neutral-500 font-body">Hari berturut</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-heading text-cultural-brown mb-1">
                {userStats.totalSessions}
              </div>
              <div className="text-xs text-neutral-500 font-body">Sesi selesai</div>
            </div>
            <div className="text-center">
              <div className="text-xl font-heading text-cultural-brown mb-1">
                {userStats.totalMinutes}
              </div>
              <div className="text-xs text-neutral-500 font-body">Menit tenang</div>
            </div>
          </div>
        </CulturalCard>
        ...
        {/* Quick access cards */}
        <div>
          <h3 className="font-heading text-cultural-brown mb-4 px-1">Jelajahi Ketenangan</h3>
            ...
            {quickAccessItems.map((item) => (
              ...
              >
                <div className="text-center space-y-3">
                  ...
                  <div>
                    <h4 className="font-heading text-neutral-800 text-sm mb-1">
                      {item.title}
                    </h4>
                    <p className="text-neutral-600 font-body text-xs leading-relaxed">
                      {item.description}
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="space-y-3">
            ...
            <blockquote className="font-cultural text-cultural-brown text-sm leading-relaxed italic">
